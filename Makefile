...
SRC = main.c check_file.c color.c hook.c init_data.c utils.c vec_culc.c phong.c ray_cross.c seach_nearest_obj.c is_shadow.c color_utils.c calc_color.c reflection_calc.c
OBJDIR = objs
